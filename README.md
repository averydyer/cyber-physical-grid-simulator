...
This project simulates a simplified electrical power grid to study
cyber-physical failures, load redistribution, and cascading failures.
...
Future features:
- Cyber attack scenario simulation (e.g., substation shutdown, breaker manipulation, telemetry spoofing)
